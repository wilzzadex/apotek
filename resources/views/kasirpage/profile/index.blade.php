            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane" id="settings">
                  <form class="form-horizontal" action="{{url('kasir/profile/'.auth()->user()->id)}}" method="POST" enctype="multipart/form-data" data-parsley-validate >
                    {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="foto" id="imgInp2" accept="image/*">
                            <img id="blah2" style="width:200px;" class="img-thumbnail" src="{{ asset('images/image_profile/'. auth()->user()->foto) }}" alt="your image" />
                        </div>
                    </div>
                    <div class="form-group row">
